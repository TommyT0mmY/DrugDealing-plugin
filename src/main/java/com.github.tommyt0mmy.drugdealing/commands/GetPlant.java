...
public class GetPlant implements CommandExecutor
{
    ...
    public boolean onCommand(@NotNull CommandSender sender,@NotNull Command cmd,@NotNull String label,@NotNull String[] args)
    {
        ...
        String usage = Objects.requireNonNull(plugin.getCommand("getplant")).getUsage().replace("<command>", label);
        ...
        switch (args[0].toLowerCase())
        {
            case "coke":
                ...
                p.getInventory().addItem(plugin.drugs.getItemStack(DrugType.COKE_PLANT));
            ...
            case "weed":
                ...
                p.getInventory().addItem(plugin.drugs.getItemStack(DrugType.WEED_PLANT));
